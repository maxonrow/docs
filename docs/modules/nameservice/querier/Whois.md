...
After the router is defined, define the inputs and responses for this queryWhois:

![Image-2](../pic/queryWhois.png)
...
```
{
    "method": "abci_query",
    "params": [
    	"/custom/nameservice/whois/mxw1x5cf8y99ntjc8cjm00z603yfqwzxw2mawemf73",
    	"",
    	"0",
    	false
    	],
...
```
{
    ...
    "result": {
        "response": {
            "code": 4005,
            "log": "{\"codespace\":\"mxw\",\"code\":4005,\"message\":\"Could not resolve address.\"}",
            "info": "",
            "index": "0",
            "key": null,
            "value": null,
